...
const ChangeEmailVerification = ({ newEmail, verificationUrl }: ChangeEmailVerificationProps) => {
  return (
          ...
          <Container className='bg-white rounded-[8px] p-[32px] max-w-[600px] mx-auto'>
            <Section>
              ...
              <Text className='text-[16px] text-gray-700 mb-[32px] mt-0'>
                To complete this change, please click the button below to verify your new email
                address:
              </Text>
