...
export class S3Service {
  ...
  constructor(private readonly envService: EnvService) {
    const config: S3ClientConfig = {
      region: this.envService.storage.region,
      credentials: {
        accessKeyId: this.envService.storage.accessKey,
        secretAccessKey: this.envService.storage.secretKey,
      },
      endpoint: this.envService.storage.url,
      forcePathStyle: true,
    };
