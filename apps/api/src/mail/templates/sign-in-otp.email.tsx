        ...
        <Body className='bg-gray-100 font-sans py-[40px]'>
          <Container className='bg-white mx-auto px-[40px] py-[40px] max-w-[600px]'>
            ...
            <Section className='text-center mb-[32px]'>
              ...
              <Text className='text-gray-600 text-[14px] m-0'>Complete your sign-in process</Text>
            </Section>

            {/* Main Content */}
            <Section className='mb-[32px]'>
              <Text className='text-black text-[16px] mb-[16px] leading-[24px]'>Hello,</Text>
              <Text className='text-black text-[16px] mb-[24px] leading-[24px]'>
                We received a request to sign in to your account. Use the verification code below to
              ...
              <Text className='text-black text-[16px] mb-[16px] leading-[24px]'>
                ...
                <strong>{secondsToMinutes(props.expiresInSeconds)} minutes</strong> for your
                security.
              </Text>
              <Text className='text-black text-[16px] mb-[24px] leading-[24px]'>
            ...
            <Section className='border-t border-solid border-gray-200 pt-[24px] mb-[32px]'>
              <Text className='text-gray-600 text-[14px] mb-[8px] leading-[20px]'>
                <strong>Security tip:</strong> Never share this code with anyone. We will never ask
